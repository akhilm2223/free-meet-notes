...
export default function Home() {
  ...
  return (
    <motion.div
      ...
      className="flex h-screen flex-col bg-[#f6f8fc]"
    >
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {(hasMicrophone || isRecording) &&
          status !== RecordingStatus.PROCESSING_TRANSCRIPTS &&
          status !== RecordingStatus.SAVING && (
            <div className="fixed bottom-7 left-0 right-0 z-20">
              <div
                className="flex justify-center transition-[margin] duration-300"
                style={{
                  marginLeft: sidebarCollapsed ? '72px' : '272px'
                }}
              >
                <div className="flex w-full max-w-[760px] justify-center px-6">
